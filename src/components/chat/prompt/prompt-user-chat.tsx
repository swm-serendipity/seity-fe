...
export default function PromptUserChat({ text }: PromptUserChatProps) {
  return (
    <div className="flex mt-6">
      ...
      <div className="bg-prompt-chat-user-bg-color px-6 pt-3 pb-4 rounded-ss-3xl rounded-se-3xl rounded-bl-3xl max-w-[600px] xl:max-w-[680px]">
        <p className="text-blackbg-default">{text}</p>
      </div>
